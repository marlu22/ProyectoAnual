...
public class ConnLogic: Conexion
...
SitemaGestionUsuarios

Console.WriteLine("Error al conectar:" ex. Message, "Error");
...
Solución "SitemaGestionUsuarios" (3 de 3
